import { LayoutTemplate, Home, Download, Save, ChevronLeft, Sparkles, Check, Loader2, Share2, Edit3, Users, Printer } from "lucide-react";
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        {onShare && (
                            <button
                                onClick={onShare}
                                className="flex items-center gap-2 px-3.5 py-2 text-neutral-700 bg-neutral-100 hover:bg-neutral-200/80 rounded-xl transition-all font-medium text-sm cursor-pointer"
                                title="Share Resume & Access"
                            >
                        ...
                        {onPrint && (
                            <button
                                onClick={onPrint}
                                className="hidden sm:flex items-center gap-2 px-3.5 py-2 text-neutral-700 bg-white border border-neutral-200 hover:bg-neutral-50 rounded-xl transition-all font-medium text-sm cursor-pointer"
                                title="Print Resume"
                            >
                        ...
                        {onDownload && (
                            <button
                                ...
                                className="group flex items-center gap-2 px-4 py-2 text-neutral-700 bg-white border border-neutral-200 rounded-xl hover:border-neutral-300 hover:bg-neutral-50 transition-all font-medium text-sm disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                            >
                                {isDownloading ? (
